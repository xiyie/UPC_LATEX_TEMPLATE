...
% 封面信息
\newcommand{\stuname}{xxx}			 	  % 学生姓名
\newcommand{\stuid}{S20050009}		  		 % 学生学号
\newcommand{\teaname}{刘宝弟}		    	  % 指导教师
\newcommand{\stugrade}{20级}			 		% 学生年级
...
\fancypagestyle{Content}{
	...
	\fancyhead[C]{\header 中国石油大学硕士学位论文开题报告及文献总结}
	\fancyhead[RE]{}
...
\begin{document}
	...
	\bibliography{reference/refs.bib}
